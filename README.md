...
|---|---|
| **Dashboard** | Widgets temps réel — carte "Aujourd'hui & demain" (tâches + événements), carte "À confirmer" (tâches/jalons/événements passés à valider ou annuler avec raison), échéances, impayés, alertes renouvellement, pipeline prospection |
