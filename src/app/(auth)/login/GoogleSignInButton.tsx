...
/**
 * Bouton de connexion Google — `signIn` côté client (next-auth/react) plutôt
 * qu'une server action à redirection externe : la navigation vers
 * accounts.google.com se fait via window.location (top-level), donc non bloquée
 * par la CSP `form-action 'self'` (le formulaire+server action l'était en prod).
 */
