...
const ALL_NAV_ITEMS: NavItem[] = [
  ...
  { label: "Dépenses",             href: "/depenses",               icon: "📉", keywords: ["depense", "dépense", "expense", "budget", "charge", "loyer", "abonnement"],                    moduleId: "depenses"    },
  { label: "Dépenses récurrentes", href: "/depenses/recurrentes",   icon: "🔁", keywords: ["depense", "dépense", "recurrent", "récurrent", "abonnement", "loyer"],                          moduleId: "depenses"    },
